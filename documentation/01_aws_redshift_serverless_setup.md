...
<br>
<img src = screenshots/aws_redshift_serverless_create_workgroup.png width = 800></img>
4. Fill in the workgroup name and click 'Next'
<br>
<img src = screenshots/aws_redshift_serverless_workgroup_name.png width = 800></img>
5. Fill in the namespace
<br>
<img src = screenshots/aws_redshift_serverless_namespace_name.png width = 800></img>
...
<br>
<img src = screenshots/aws_redshift_serverless_db_pwd.png width = 800></img>
7. Click 'Next'
<br>
<br>
...
<br>
<img src = screenshots/aws_redshift_serverless_main_workgroup.png width = 800></img>
<br>
9. Scroll down, find 'Network and security', and then click the 'security group'
<br>
<img src = screenshots/aws_redshift_serverless_security_group.png width = 800></img>
<br>
10. In the security group page you just opened, click 'Inbound rules' tab and then 'Edit inbound rules'.
<br>
<img src = screenshots/aws_redshift_serverless_sg_inbound.png width = 800></img>
<br>
11. Click 'add rule', set inputs as the following picture and then save rules.
<br>
<img src = screenshots/aws_redshift_serverless_sg_inbound_rule_setting.png width = 800></img>
<br>
12. Go back to the workgroup page, find 'Network and security', and then click the 'Edit'.
<br>
<img src = screenshots/aws_redshift_serverless_publicly_accessible01.png width = 800></img>
<br>
13. Scroll down, tick the 'Turn on publicly accessbile', and save changes.
<br>
<img src = screenshots/aws_redshift_serverless_publicly_accessible02.png width = 800></img>
