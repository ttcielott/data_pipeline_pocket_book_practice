...
# query the documents to extract
...
# batch_size: PyMongo makes a round-trip to the MongoDB host for each batch
# for example, if the result_docs Cursor has 6,000 results, it will take two trips
event_docs = mongo_collection.find(mongo_query, batch_size = 3000)
print(f"even_doc: {event_docs}")
...
for doc in event_docs:
    ...
    # if a value doesn"t exist, return "-1"
    ...
    # add al the event properties into a list
    current_event = []
